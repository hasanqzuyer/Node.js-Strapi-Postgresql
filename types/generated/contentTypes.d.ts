...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    firstName: Attribute.String;
    lastName: Attribute.String;
    user_avatar: Attribute.String;
    notification_enable: Attribute.Boolean & Attribute.DefaultTo<true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'plugin::users-permissions.user',
...
export interface ApiEventEvent extends Schema.CollectionType {
  ...
  attributes: {
    ...
    rrule_text: Attribute.Text;
    repeat_data: Attribute.JSON;
    duration: Attribute.Text;
    action: Attribute.Text;
    synced_with_google: Attribute.Boolean & Attribute.DefaultTo<false>;
    deleted: Attribute.Boolean & Attribute.DefaultTo<false>;
    reminder: Attribute.Integer & Attribute.DefaultTo<0>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiNotificationNotification extends Schema.CollectionType {
  ...
  attributes: {
    notificationOwner: Attribute.Relation<
    ...
    status: Attribute.String & Attribute.DefaultTo<'false'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
